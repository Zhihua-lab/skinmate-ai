...
$env:FACEPP_API_KEY="your-api-key"
$env:FACEPP_API_SECRET="your-api-secret"
...
- Face++ credentials are read from `FACEPP_API_KEY` and `FACEPP_API_SECRET`. Do not commit real credentials.
